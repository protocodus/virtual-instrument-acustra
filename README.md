...
| `03-shape-material-anchors.wav` | One chord: Parlor/Jumbo, then Cedar/Maple anchor settings | 13.7 s | −7.9 dBFS | +4.9 dB |
| `04-string-age.wav` | The same steel phrase with fresh strings, then fully aged strings | 6.5 s | −8.1 dBFS | +5.1 dB |
| `05-alternate-tunings.wav` | Drop D, DADGAD and Open G chords | 12.3 s | −7.5 dBFS | +4.5 dB |
...
and only the pitch-trajectory term moves the other way. This is why the steel
presets now play it.
...
- Shape and Body Material morph whichever measured body the string material
  ...
  steel presets play adds actual steel-guitar mobility, but a matched steel
  microphone-radiation measurement remains missing.
