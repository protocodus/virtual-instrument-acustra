...
- High fretted notes settle a few cents flat of their attack; the
  ...
  1.199). Woodhouse measured the correction on an open string and publishes
  no law for a fret. Zeroing it restores the trajectory (0.659) but loses
  more on the attack and decay terms than it gains: Fylde bridge training
  +0.15%, development validation +0.23%, flat-top +0.68%.
